...
from bug_prioritization_engine.api.routes import router
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from bug_prioritization_engine.data.jira_fetcher import JiraFetcher
    ...
    from bug_prioritization_engine.models.predictor import BugPredictor
    ...
    from bug_prioritization_engine.scheduler.retrain_job import build_scheduler
